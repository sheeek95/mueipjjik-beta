...
- (기온대×스타일) 조합마다 옷차림 대안을 2개씩 준비해뒀어요(`STYLE_OUTFITS`). 매번 똑같은 옷만 추천되는 걸 막고, 추천된 옷을 안 갖고 있어도 "다른 코디 보기" 버튼으로 같은 조건 안에서 바로 다른 조합을 볼 수 있어요. 날씨를 다시 불러오거나 스타일을 바꾸면 항상 첫 번째(기본) 조합부터 다시 보여줘요.
